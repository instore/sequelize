...
module.exports = (function() {
  ...
  BelongsTo.prototype.injectGetter = function(obj) {
    ...
    obj[accessor] = function(params) {
      ...
      query = self.target.find(params)
      query.success(function(result){
        obj[Utils._.camelize(Utils.singularize(self.target.tableName))] = result
        if(result){ result[Utils._.camelize(Utils.singularize(self.source.tableName))] = obj }
      })
      return query
    }
